  ...
  return {
    ...
    outputDigest: sha256(
      canonicalJson({
        ...
        overallMutation: overallReport,
        oracle: oracleReport,
        propertyCampaigns: 12,
        propertyExecutions: 12 * 4096,
        propertySeed: "0x4e4f454f",
        propertyEvidence: {
          id: "P4-PROP-011",
          seed: "0x4e4f454f",
          executions: 4096,
          ...
          shrinkerRegression: {
            seeded: true,
            steps: ["numserie-prefix", "importe-negative-zero", "fecha-anchor"],
            minimalNumserie: "S",
            minimalFecha: "2000-01-01",
            minimalImporte: "-0",
          },
        },
        fuzzCampaigns: [
    ...
    diagnostics: [
      ...
      `overall mutants killed=${overallReport.killed}/${overallReport.population} (${overallReport.killedPercent}%) across ${overallReport.productionFiles} production files; survivors=${overallReport.survivors.length} timeouts=${overallReport.timeouts}`,
      "P4 property executions=49152 across 12 declared properties; P4-PROP-011 uses seed 0x4e4f454f",
      "P4-E QR property seed=0x4e4f454f executions=4096; seeded fault shrunk in three steps",
      "P4-E cumulative fuzz executions=20480 across P4-FUZZ-001/002/003/005/006; P4-D P4-FUZZ-004 is a separate gate",
