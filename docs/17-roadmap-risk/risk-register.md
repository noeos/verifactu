...
| `RISK-P3B-002` first P4 commit bypasses quantitative controls                                                          | quality-owner    | Before first P4 fiscal implementation PR               | exact module/test populations, 36 critical branches/mutants, campaigns, matrix and budgets in `P4-QUALITY-PLAN-0001`; canonical readiness task | Blocks that commit and P4 continuation                                        |
