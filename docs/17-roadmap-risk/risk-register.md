...
| `RISK-P3B-002` first P4 commit bypasses quantitative controls                                                          | quality-owner    | First P4 commit, no later than its protected PR date   | canonical coverage/mutation/property/fuzz/fault/recovery/performance/compatibility policies in `P3B-BASELINE-0001` | Blocks that commit and P4 continuation                                        |
